...
const Footercta = () => {
  return (
    <section className={`${style.footercta} after:content-[''] after:absolute after:bg-black after:opacity-50 after:z-1 after:left-0 after:w-full after:h-full after:top-0 min-h-[1090px] lg:min-h-[739px]`}>
      ...
      <div className="container">
        <div className="text-wrap w-full relative z-2">
