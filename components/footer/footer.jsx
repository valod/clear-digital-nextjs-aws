...
const Footer = () => {
  return (
    <>
      <div className="footer-clear-digital">
        <div className="container">
          ...
          <div class="item small">
                ...
                <div class="location-wrap">
                    <div class="icon-wrap">
                        <Link href="/" class="icon" data-cursor-expand="">
                            <span class="sr-only">Address</span>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21 10C21 17 12 23 12 23C12 23 3 17 3 10C3 7.61305 3.94821 5.32387 5.63604 3.63604C7.32387 1.94821 9.61305 1 12 1C14.3869 1 16.6761 1.94821 18.364 3.63604C20.0518 5.32387 21 7.61305 21 10Z" stroke="#FA198C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="#FA198C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </Link> 
                    </div>
                    <div class="location-title">
                        <p class="body-default">1570 The Alameda #330, San Jose, CA 95126</p>
                    </div>
                </div>
            ...
            <div class="item medium">
                <div class="list-item">
                    <ul>
                        <li>
                            <Link href="/" class="subtitle text-white" data-cursor-expand="">Work </Link> 
                        </li>
                        <li>
                            <Link href="/" class="subtitle text-white" data-cursor-expand="">Approach</Link> 
                        </li>
                        <li>
                            <Link href="/" class="subtitle text-white" data-cursor-expand="">Services </Link> 
                        </li>
                        <li>
                            <Link href="/" class="subtitle text-white" data-cursor-expand="">About </Link> 
                        </li>
                        <li>
                            <Link href="/" class="subtitle text-white" data-cursor-expand="">Contact Us</Link> 
                        </li>
                    </ul>
                </div>
            </div>
            <div class="item large">
                <div class="content-wrap">
                    ...
                    <div class="intro">
                        <h2 class="h4 text-white">2023 Fortune 500 B2B Homepage Rankings Report</h2>
                        <p class="body-default">Sed sollicitudin odio ac ornare consequat. Ut massa justo, hendrerit vel
                            nunc non, tempus
        ...
        <div className="container">
          ...
          <div class="logo-wrap">
            ...
            <div class="title-wrap">
                <p class="subtitle">Clear Digital is a founding member of Myrious Group’s expertise-driven agencies.</p>
                <p class="body-default">Myrious Group is an independent holding company enabling forward-thinking brands
