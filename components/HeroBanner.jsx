...
const HomepageHero = () => {
  return (
    <section id="HomepageHero" className={`${styles.herobanner} min-h-screen`}>
      ...
      <div className={`${styles['bg-img']} bg-container overlay`} data-astro-cid-g47crtsm="" style={{ '--cssImg': 'url(https://dev-clear-astro-wp.pantheonsite.io/wp-content/uploads/2023/10/iStock-1280582431-1.webp)' }}>
